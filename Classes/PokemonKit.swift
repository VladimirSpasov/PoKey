...
open class PKMStatMas: Mappable {

    /// The maximum amount of change to the referenced Pokéathlon stat
    open var effort: Int?

    /// The maximum amount of change to the referenced Pokéathlon stat
    open var base_stat: Int?
...
//        let sessionManager = Alamofire.SessionManager(configuration: configuration)
        ...
        let request = Alamofire.request(URL, method: .get).responseObject { (response: DataResponse<PKMPokemon>) in
